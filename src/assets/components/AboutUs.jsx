...
export default function AboutUs() {
  return (
    <section id="sobre" className="py-16 bg-black md:bg-white transition-colors duration-500">
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="md:w-1/2 text-center md:text-justify">
          ...
          <p className="text-white md:text-black mb-4 text-justify">
            A <strong>GUICAR Recuperadora de Veículos</strong> atua há mais de 5 anos oferecendo serviços de funilaria, pintura e polimento de alta qualidade. Nosso compromisso é devolver a beleza e segurança do seu carro, utilizando técnicas modernas e materiais de primeira linha.
          </p>
          <p className="text-white md:text-black mb-4 text-justify">
          ...
          <p className="text-white md:text-black text-justify">
