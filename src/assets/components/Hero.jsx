  ...
  return (
    ...
    >
      ...
      <div className="relative z-30 max-w-2xl text-white px-4 flex flex-col items-center">
        ...
        <p className="text-base text-justify sm:text-lg mb-12 text-gray-200 max-w-xl mx-auto max-[375px]:hidden">
        ...
        <a
          ...
          className="bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-4 px-10 rounded-full shadow-xl transform transition-all hover:scale-105 max-[375px]:hidden sm:inline-flex"
        >
