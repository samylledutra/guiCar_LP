...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden max-[545px]:flex hidden items-center justify-center">
        {/* Fundo desfocado */}
        <video
          src={videoBg}
          autoPlay
        ...
        <video
          ...
          muted
          playsInline
          className="absolute top-1/2 left-1/2 w-auto h-full transform -translate-x-1/2 -translate-y-1/2 object-contain z-10 scale-[1.34]"
        />
      </div>

      <div className="absolute inset-0 bg-black/50 z-20 max-[545px]:hidden"></div>

      {/* Conteúdo principal */}
      <div className="relative z-30 max-w-2xl text-white px-4 flex flex-col items-center">

        <h2 className="uppercase font-extrabold mb-4 leading-tight drop-shadow-xl max-[545px]:hidden">
        ...
        <p className="text-base text-justify sm:text-lg mb-12 text-gray-200 max-w-xl mx-auto max-[545px]:hidden">
        ...
        <a
          ...
          className="bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-4 px-10 rounded-full shadow-xl transform transition-all hover:scale-105 max-[545px]:hidden sm:inline-flex"
        >
